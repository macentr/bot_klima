...
def main_menu_greeting(vacation_status: str) -> str:
    ...
    return (
        ...
        f"💡 Не знаешь с чего начать? Нажмите кнопку **Помощь** для краткого гайда.\n\n"
...
def help_message() -> str:
    ...
    return (
        ...
        "**✨ Кастомные события**\n"
        "Нужно что-то особенное? Нажми **\"✨ Свое событие\"** в комнате!\n"
        "• Настольный теннис (15 мин)\n"
        "• Обед (45 мин)\n"
        "• Пробежка (20 мин)\n"
        "Любое описание до 256 символов!\n\n"
